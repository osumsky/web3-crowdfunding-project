    ...
    >
      ...
      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          ...
          <p className="ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] dark:text-stone-500 text-stone-800">
            Education
          </p>
        </div>
        ...
        {/* Title + Description */}
        <div className="block">
          <h3 className="font-epilogue font-semibold text-[16px] dark:text-stone-50 text-black text-left leading-[28px] truncate">
            {title}
          </h3>
          <p className="mt-[4px] font-epilogue font-normal dark:text-stone-500 text-stone-800 text-left leading-[18px] truncate">
            {description}
          </p>
        </div>
        ...
        <div className="flex justify-between flex-wrap mt-[16px] gap-2">
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] dark:text-stone-300 text-stone-900 leading-[22px] text-center">
              {amountCollected}
            </h4>
            <p className="mt-[4px] font-epilogue font-normal text-[12px] leading-[18px] dark:text-stone-500 text-stone-700 truncate sm:max-w-[120px]">
              {t('raised_of')} {target}
            </p>
          </div>
          <div className="flex flex-col">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          ...
          <p className="flex-1 font-epilogue font-normal text-[12px] dark:text-stone-500 text-stone-800 truncate">
